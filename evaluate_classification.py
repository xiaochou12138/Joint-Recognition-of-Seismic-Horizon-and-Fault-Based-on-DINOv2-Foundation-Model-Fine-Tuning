...
if __name__ == '__main__':
    ...
    model_Path = 'checkpoint_structure_F3_task/'+ args.dataset +'/'+ args.loss +'/'+args.netType +'/'+args.checkpointName + "_" + args.vt+'_minloss_valid.pth'
    lora_Path = 'checkpoint_structure_F3_task/'+ args.dataset +'/'+ args.loss +'/'+args.netType +'/'+args.checkpointName + "_" + args.vt+'_minloss_valid_lora.pth'
