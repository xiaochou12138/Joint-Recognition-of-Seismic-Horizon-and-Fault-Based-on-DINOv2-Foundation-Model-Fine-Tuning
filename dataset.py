...
class BasicDataset(Dataset):
    ...
    def __init__(self,patch_h,patch_w,datasetName,netType,train_mode = False):
        ...
        if datasetName == 'fault':
            self.n1 = 224
            self.n2 = 224
            self.train_data_dir = 'data/Horizon_and_fault/train/seis'
            self.train_label_dir = 'data/Horizon_and_fault/train/fault'
            self.valid_data_dir = 'data/Horizon_and_fault/valid/seis'
            self.valid_label_dir = 'data/Horizon_and_fault/valid/fault'
            ...
            self.n1 = 384
            self.n2 = 128
            self.train_data_dir = 'data/F3_dataset/train/seis'
            self.train_label_dir = 'data/F3_dataset/train/label'
            self.valid_data_dir = 'data/F3_dataset/valid/seis'
            self.valid_label_dir = 'data/F3_dataset/valid/label'
        else:
            print("Dataset error!!")
    ...
    def __getitem__(self,index):
        ...
        label = np.fromfile(tPath,np.float64).reshape(self.n1,self.n2)
        ...
        return data[:,:,:378, :126],label  # [:,:,:378, :126]
...
if __name__ == '__main__':
    ...
    train_set = BasicDataset(27,9,'structure','setr1',True)
